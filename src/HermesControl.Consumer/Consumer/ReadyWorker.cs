...
public class ReadyWorker : BackgroundService
{
    private readonly ILogger<ReadyWorker> _logger;
    private readonly IOrderQueue _orderQueue;
    private readonly IPaymentGateway _paymentService;
    private readonly AsyncCircuitBreakerPolicy _circuitBreakerPolicy;
    private readonly IOrderUseCase _orderUseCase;

    public ReadyWorker(ILogger<ReadyWorker> logger, IOrderQueue orderQueue, IPaymentGateway paymentService, IOrderUseCase orderUseCase)
    {
        _logger = logger;
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        {
            var order = await _orderQueue.ConsumeAsync(Status.Ready.ToString());
