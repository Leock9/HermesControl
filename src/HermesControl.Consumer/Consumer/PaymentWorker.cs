...
public class PaymentWorker : BackgroundService
{
    ...
    public PaymentWorker(ILogger<PaymentWorker> logger, IOrderQueue orderQueue, IPaymentGateway paymentService, IOrderUseCase orderUseCase)
    {
        _logger = logger;
            ...
            if (order is not null)
            {
                ...
                try
                {
                    ...
                    await _circuitBreakerPolicy.ExecuteAsync(async () =>
                    {
                        ...
                        await _orderUseCase.UpdateStatusOrderAsync(new UpdateOrderStatusRequest(order.Id, (int)Status.Preparation));
